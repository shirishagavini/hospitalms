...
class AppointmentListForPatients extends StatefulWidget {
  const AppointmentListForPatients({super.key});

  @override
  State<AppointmentListForPatients> createState() =>
      _AppointmentListForPatientsState();
}

class _AppointmentListForPatientsState
    extends State<AppointmentListForPatients> {
  @override
